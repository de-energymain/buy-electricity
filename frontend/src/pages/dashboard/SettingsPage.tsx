  ...
  const fetchNotificationPreferences = async () => {
    ...
    try {
      const response = await fetch(
        `https://buy-electricity-production.up.railway.app/api/users/${walletID}/notifications`
      );
      if (response.ok) {
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
          <div>
            ...
            <p className="text-gray-400">
              Effortlessly configure, customise and personalise your dashboard.
            </p>
          </div>
        </div>
          ...
          <div className="md:col-span-1">
            <Card className="bg-[#1A1A1A] border-none h-min sticky top-6">
              <CardBody className="p-0 text-white">
                ...
                <div className="p-0">
                  <Button
                    className={`w-full justify-start rounded-none p-4 text-white ${
                      activeTab === "account"
                        ? "bg-[#2A1A1A] border-l-4 border-[#E9423A]"
                        : "bg-transparent hover:bg-[#2A1A1A]"
                    }`}
                ...
                <CardBody className="p-6">
                  ...
                  {isLoadingUserData ? (
                    <div className="flex items-center justify-center p-8">
                      <Loader2
                        size={24}
                        className="animate-spin text-[#E9423A] mr-2"
                      />
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <Button
                        className={`${
                          hasUnsavedChanges ? "bg-[#E9423A]" : "bg-gray-600"
                        } text-white`}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 bg-[#2A1A1A] rounded-lg">
                      ...
                      <Switch
                        ...
                        onValueChange={(value) =>
                          handleNotificationToggle("transactions", value)
                        }
                        color="danger"
                        isDisabled={isUpdatingNotifications}
                      />
